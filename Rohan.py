...
# ==== CONFIG ====
API_ID = 25178048  # Replace with your actual API ID
API_HASH = "d2d5ccf4592270fd54ad9e2014c960e7"  # Replace with your actual API HASH
...
async def start(_, message: Message):
    await message.reply("Hey! Use `/play <song name or YouTube URL>` in a group voice chat.")
...
async def play(_, message: Message):
    ...
    try:
        ...
        return await msg.edit(f"❌ Failed to get audio: `{e}`")
    ...
    try:
        ...
        await msg.edit(f"❌ Failed to start VC: `{e}`")
