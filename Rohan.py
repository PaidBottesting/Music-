...
from pytgcalls import GroupCallFactory  # Simplified import
...
call_handler = GroupCallFactory(app).get_group_call()
...
def play_next(context, chat_id):
    ...
    try:
        ...
        call_handler.join_group_call(
            ...
            f"{DOWNLOAD_PATH}/song.mp3"  # Direct file path for 3.0.0.dev3
        )
